# [](https://github.com/startupjs/startupjs/compare/v0.29.12...v) (2020-12-12)
...
* **auth): Fix layout. fix(ui->Button:** Fix hover and active styles ([f4683e8](https://github.com/startupjs/startupjs/commit/f4683e8cc2f71c32c1908604b5ee03710ce2b943))
...
* **ui->Input): add 'datetime' and 'time'. fix(ui->Input:** 'date' input by default uses mode 'date' of DateTimePicker ([905dce8](https://github.com/startupjs/startupjs/commit/905dce83d53e45b4dc1aa5d7d05607e6d92d21a1))
...
* **Tooltip:** show ([#386](https://github.com/startupjs/startupjs/issues/386)) ([c5d0be7](https://github.com/startupjs/startupjs/commit/c5d0be723ee061d298a58835e45c3a2f4261767e))
...
* **AutoSuggest/Dropdown:** key events ([#394](https://github.com/startupjs/startupjs/issues/394)) ([5539f59](https://github.com/startupjs/startupjs/commit/5539f598ee9886ba700daabc69f35f6ed3ad52d5))
...
* **Input): add number type. fix(Sandbox:** Fix parsing prop-types. feat(ObjectInput) ([b0796da](https://github.com/startupjs/startupjs/commit/b0796da848cdcb5b19bb9503249ca209ed325a05))
...
* async parseUserCreationData ([22d2bea](https://github.com/startupjs/startupjs/commit/22d2beac8310c5497bf385d3a61250c2d0470de0))
* Hooks PR ([9b95c45](https://github.com/startupjs/startupjs/commit/9b95c45a157e2c7b735a8cece3a8e23c2a808831))
* onBeforeLogintHook, parseUserCreationData ([131f02f](https://github.com/startupjs/startupjs/commit/131f02f36ba7af13ad55dcb6f3c7b53b47618284))
...
* **Link:** fix non-clickability on native when link is like a button ([#382](https://github.com/startupjs/startupjs/issues/382)) ([710dd76](https://github.com/startupjs/startupjs/commit/710dd764e02b94d39318bff57a27a44c4bbf3560))
* **SmartSidebar:** remove default open for drawer ([#385](https://github.com/startupjs/startupjs/issues/385)) ([9c47f21](https://github.com/startupjs/startupjs/commit/9c47f21b56a2355953a0444b11765dda153bbfad))
* **Tag:** remove proptypes ([#375](https://github.com/startupjs/startupjs/issues/375)) ([ce4cdfc](https://github.com/startupjs/startupjs/commit/ce4cdfcbb94344034433c7163d67f4878b7a9bf4))
* **TextInput:** fix passing styles in TextInput component ([#374](https://github.com/startupjs/startupjs/issues/374)) ([a80304b](https://github.com/startupjs/startupjs/commit/a80304b162ee51e8389ec7775a6ee05ef933238e))
...
* **useRestoreScroll:** don't scroll to top of the page on initial render if you are scrolled or don't scroll page yet ([#355](https://github.com/startupjs/startupjs/issues/355)) ([fdb88dc](https://github.com/startupjs/startupjs/commit/fdb88dc5031226d08aca40e8b777bd33f272aa84))
...
* **Checkbox:** fix mobile readonly ([#347](https://github.com/startupjs/startupjs/issues/347)) ([b3cb994](https://github.com/startupjs/startupjs/commit/b3cb99413ec8ba5e94aed7dc58bffb2cc77d7dfe))
* **shadows:** change level 0 in shadows because of ios ([89ba799](https://github.com/startupjs/startupjs/commit/89ba799d314c44e18ec3bc444a6683de5691c29b))
...
* **ui->Sidebar): Remove animations to improve UX and performance. fix(docs:** Add topbar with the button to toggle sidebar. deps: upgrade react-native-web to 14.x ([2b349cc](https://github.com/startupjs/startupjs/commit/2b349cc020d74585aba0b77bd6bdd8773c665803))
...
* **bundler): improve replaceObserverLoader to ignore comments. refactor(vite:** remove duplicated loaders ([58562e8](https://github.com/startupjs/startupjs/commit/58562e80f6f0d00bf18e053c7423a76623fc9fea))
...
* quickfix. minor ([40dce69](https://github.com/startupjs/startupjs/commit/40dce695d4facc97d723f042dfb36ba018f44870))


### Features

* **ui:** BREAKING! Remove support for JS configuration from `startupjs.config.cjs` completely. Override only in stylus in $UI. ([0911328](https://github.com/startupjs/startupjs/commit/0911328bec8e8d2c007e765129a76e2837e27dc0))
...
* **components/Content:** add default style(width 100%, align) ([#263](https://github.com/startupjs/startupjs/issues/263)) ([f649ab9](https://github.com/startupjs/startupjs/commit/f649ab9fa8ec606c70671283bb8017e26880f2da))
...
* **Checkbox:** props ([#258](https://github.com/startupjs/startupjs/issues/258)) ([d620dc7](https://github.com/startupjs/startupjs/commit/d620dc7c65c0b875b73ec2a6ae089cac84bb2bc8))
...
* move stylus to peer deps ([94a9b86](https://github.com/startupjs/startupjs/commit/94a9b86ec92094b8a57abab8a71cf2efabec5c95))
...
* **Checkbox:** add flex-shrink for label ([#231](https://github.com/startupjs/startupjs/issues/231)) ([8a1c698](https://github.com/startupjs/startupjs/commit/8a1c698d2af9ccd98af72ba5817c70a99012bcf0))
...
* **TextInput:** fix description props for textinput ([#232](https://github.com/startupjs/startupjs/issues/232)) ([91a6006](https://github.com/startupjs/startupjs/commit/91a6006dd92d6802e39a5d57cf26e91d543b89d5))
...
* **Modal:** add defaultProps to modal ([#212](https://github.com/startupjs/startupjs/issues/212)) ([f50a964](https://github.com/startupjs/startupjs/commit/f50a964416b26cc45dea7089bf7e21712b7d61f3))
...
* **SmartSidebar:** add sidebar option ([#210](https://github.com/startupjs/startupjs/issues/210)) ([f5366b7](https://github.com/startupjs/startupjs/commit/f5366b7ee6b68e464b17fa40e14aea6e8525c3f7))
* remove redundant legacyClassnames ([#209](https://github.com/startupjs/startupjs/issues/209)) ([6b7b027](https://github.com/startupjs/startupjs/commit/6b7b0272010ead99ec94256f55d37a2693458b13))
...
* do async build by default ([bda8a86](https://github.com/startupjs/startupjs/commit/bda8a869ac9c28ecf527d287f8297a1661a6f4c5))
...
* **template): Add index.html. fix(vite:** include startupjs/orm ([8bc2795](https://github.com/startupjs/startupjs/commit/8bc27950b296ef95b5d60b9b98166eb76c2fb710))
...
* update extension ([5618a1f](https://github.com/startupjs/startupjs/commit/5618a1fbb4c3f807e6f0c482ff6d9ee58a4f3011))
...
* **ui:** fix mobile crash, update Div ru docs ([#205](https://github.com/startupjs/startupjs/issues/205)) ([b407573](https://github.com/startupjs/startupjs/commit/b407573834b6337ca61b8628b213c1679675c307))
...
* **ui->ObjectInput): Refactor and add label support. feat(ui->TextInput): Add inputStyle prop. fix(bundler:** Fix errors with new lines in MDX ([6fd22bd](https://github.com/startupjs/startupjs/commit/6fd22bd2724adb9d5a83c1cae02301cca579c4dd))
...
* **ui:** add auto suggest ([#200](https://github.com/startupjs/startupjs/issues/200)) ([4b753f4](https://github.com/startupjs/startupjs/commit/4b753f4e75f59b9fec79d1847896d59a9c2838c3))
* **ui:** add dropdown ([f4efe77](https://github.com/startupjs/startupjs/commit/f4efe777506b658f01d4fab40e2ad7f2b944a820))
* **ui:** add popover ([244bb35](https://github.com/startupjs/startupjs/commit/244bb35d15fcb17dfc8fb564405baa095b642fc9))
* **ui:** extend drawer ([416b433](https://github.com/startupjs/startupjs/commit/416b4338a3a2e75cc90957ca7413905f5ac27385))
...
* **docs:** Minor, set dismiss label of options to Close ([dc48b2f](https://github.com/startupjs/startupjs/commit/dc48b2f401d4ae655d2281ba869460297311ed1b))
...
* **ui->Checkbox, ui->Radio:** Improve styles, remove extra spacing. ([26746fa](https://github.com/startupjs/startupjs/commit/26746fab179d11288c9e2b9a0e53a94ff1b9d8d0))
...
* **docs): Redesign sidebar. fix(ui->TextInput): Fix min-width on web. feat(ui->Select): Add showEmptyValue option. fix(ui->Modal:** Fix passing button labels ([c5ad5b8](https://github.com/startupjs/startupjs/commit/c5ad5b888d543ac42bc4d96908495baae84afe82))
...
* **ui:** export Select ([d7725f2](https://github.com/startupjs/startupjs/commit/d7725f2f6ad1f46a26d0e5512d80b9cefb23a516))
...
* **app:** update '' when query params change ([#191](https://github.com/startupjs/startupjs/issues/191)) ([b5c00e2](https://github.com/startupjs/startupjs/commit/b5c00e27bc037a6f9c3e899a4756bd6f224c4b6d))
