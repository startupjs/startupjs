...
- [React Router](https://reacttraining.com/react-router/) for routing and navigation with an ability to separate your frontend into [multiple frontent mircoservices](https://github.com/dmapper/startupjs/blob/master/packages/app) (e.g. `main` and `admin`)
...
- [MongoDB](https://docs.mongodb.com/manual/installation/) for the database.
