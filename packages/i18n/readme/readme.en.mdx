...
## Auto-Replacement of words

Create translations.json in the project folder, for example:
...
```json
{
  "ru": {
    ...
    "PHome/index.js": {
      "listEmployees": "Список сотрудников",
      "defaultValue": "A list of employees"
    }
  },
  "ua": {
    "PAbout/index.js": {
    ...
    "PHome/index.js": {
      "listEmployees": "Список працівників",
      "defaultValue": "A list of employees"
    }
  }
}
...
In the prescribed files, you need to use the function - t:
...
Depending on the selected language, the text is replaced when compiling the code
