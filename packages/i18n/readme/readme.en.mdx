...
To avoid having to write a config with translations manually, you can use the `t` function
...
The first argument is the name of the tag for words, the second is the default

When compiling the project, all files that use this function will be found, and a config will be generated in the format:
...
Initially, words are filled only for the default language, the rest of the words of other languages ​​can be changed on the page - $ {BASE_URL} / i18n
