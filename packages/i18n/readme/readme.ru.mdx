...
Создать translations.json в папке проекта, н-р:
...
В прописанных файлах нужно использовать функцию - t:
...
В зависимости от выбранного языка происходит замена текста при компиляции кода
