...
## Инициализация модуля на клиенте
...
```
В поле `type` указывайте какой [тип reCAPTCHA](https://www.google.com/recaptcha/about) вы хотите использовать (возможные типы: `enterprise` или `v3`)

В функцию `getHead` добавить нужный скрипт:
```js
  // Если будете использовать reCAPTCHA v3
  <script src="https://www.google.com/recaptcha/api.js" async defer></script>
  // Если будете использовать reCAPTCHA Enterprise
...
`checkDataRecaptcha(recaptcha)` - расширенная функция `checkRecaptcha(recaptcha)`, которая возвращает объект с оригинальным ответом Google API. Разные типы reCAPTCHA возвращают разную структуру данных в ответе.
