...
Свойство for указывает, для какой части приложения предназначен этот плагин. Например, если вы создаете плагин для административной части вашего приложения, вы можете указать for: 'admin'. Если ваш плагин подключен к какому-либо модулю, то здесь необходимо указать название этого модуля.
