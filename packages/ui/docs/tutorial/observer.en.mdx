...
- forwardRef - if true is passed, then React.forwardRef will be used as the `FunctionalComponent` argument
- suspenseProps
- fallback - React component (`<MyComponent />`)
