...
| 1        | box-shadow: 0 1px 2px var(--color-shadow) и elevation: 3         |
| 2        | box-shadow: 0 3px 5px var(--color-shadow-strong) и elevation: 6  |
| 3        | box-shadow: 0 5px 8px var(--color-shadow-strong) и elevation: 12 |
| 4        | box-shadow: 0 8px 12px var(--color-shadow) и elevation: 18       |
