...
- `$UI.fontFamilies.normal` - contains font names for Span(default and description variants).
- `$UI.fontFamilies.heading` - contains font names for Span(h1, h2, h3, h4, h5, h6 variants).
