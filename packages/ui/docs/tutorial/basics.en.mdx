...
Let us look at the [documentation for the Content component](/docs/components/Content#Vertical%20paddings). We see that to add padding on all four sides, we need to add the `padding` prop to component.
