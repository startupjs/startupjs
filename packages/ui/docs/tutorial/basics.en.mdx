...
```
Thus, you gave the title H1 a `title` class and now in the css file `index.styl` you can refer to it by the `.title` selector, adding the necessary styles to it
