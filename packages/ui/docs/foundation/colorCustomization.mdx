...
const THEMES = {
  dark: generateColors(CUSTOM_COLOR_PALETTE, {
    [Colors.bg]: CUSTOM_COLOR_PALETTE.coolGray[9],
    [Colors.text]: CUSTOM_COLOR_PALETTE.coolGray[0],
    [Colors.border]: CUSTOM_COLOR_PALETTE.coolGray[7],
    [Colors.secondary]: CUSTOM_COLOR_PALETTE.coolGray[0],
    [Colors.contrast]: CUSTOM_COLOR_PALETTE.coolGray[0]
  })
}
...
