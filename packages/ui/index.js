...
export { default as ErrorTemplate } from './app/ErrorTemplate'
export { default as pathFor } from './app/pathFor'
...
export { default as useRouteMatch } from './app/useRouteMatch'
export { default as initPortal } from './plugins/initPortal'
