...
return (
  <Div>
    <Button onPress={() => console.log('pressed')} icon={faCoffee}>
      Outlined
    </Button>
    <Br />
    <Button onPress={() => console.log('pressed')} variant='flat' icon={faCoffee}>
      Flat
    </Button>
    <Br />
    <Button onPress={() => console.log('pressed')} variant='text' icon={faCoffee}>
      Text
    </Button>
  </Div>
)
