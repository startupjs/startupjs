...
return pug`
  Div
    Button(icon=faCoffee) Контурная
    Br
    Button(variant='flat' icon=faCoffee) Плоская
    Br
    Button(variant='text' icon=faCoffee) Текстовая
`
```
...
return pug`
  Div
    Button(variant='flat') Default dark
    Br
    Button(color='primary' variant='flat') Primary
    Br
    Button(color='success' variant='flat') Success
`
```
...
return pug`
  Div
    Button(variant='flat' size='s' icon=faCheck) Small
    Br
    Button(variant='flat' icon=faCheck) Default
    Br
    Button(variant='flat' size='l' icon=faCheck) Large
`
```
...
return pug`
  Div
    Button.button(icon=faCoffee iconStyleName='icon')
...
return pug`
  Row(align='right')
    Button Cancel
    Button(pushed color='primary' variant='flat') OK
`
```
