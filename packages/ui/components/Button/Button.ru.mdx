...
Цвет по умолчанию `dark`. Его можно изменить, передав имя цвета из списка цветов конфига в свойство `color`. Возможные значения свойства можно найти в разделе `Sandbox` внизу страницы.
