...
// TODO: Move DynamicThemeProvider to basic startupjs and also move the singleton variables file to some generic lib
...
export default function DynamicThemeProvider ({ variables = {}, clear = true, children }) {
  // TODO: Figure out if we would want to transition default UI colors to be dynamic
