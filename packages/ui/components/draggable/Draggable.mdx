...
const [data, setData] = useState([
  {
    ...
    items: [
      ...
      { id: '13aabadc-113d-4d53-8e6f-a83a184e229d', text: 'Buy a new gaming 2' },
...
function onDragEnd ({
  ...
  data[dropHoverIndex].items.splice(hoverIndex, 0, data[dropIndex].items[dragIndex])
  data[dropIndex].items.splice(dragIndex, 1)
