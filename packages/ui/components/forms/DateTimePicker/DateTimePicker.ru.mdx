...
format - строка для форматирования даты из [moment](https://momentjscom.readthedocs.io/en/latest/moment/04-displaying/01-format/)
...
minuteInterval - интервал через который можно выбрать минуты (по умолчанию - 1)
