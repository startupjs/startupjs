...
There are three options for managing the state of a DateTimePicker:
...
2. By passing the `visible` property that determines whether DateTimePicker is visible.
...
3. Not passing the `visible` property.
