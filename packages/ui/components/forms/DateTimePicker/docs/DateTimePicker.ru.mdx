...
Для управления состоянием DateTimePicker есть три варианта:
...
2. Передав свойство `visible`, которое определяет является ли DateTimePicker видимым.
