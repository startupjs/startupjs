...
- renderTooltip (function: ReactNode | string | number): рендер-функция, возвращающая содержимое тултипа (JSX, строка или число)
- tooltipProps (object): дополнительные параметры, идентичные [Popover](/docs/popups/Popover): style, position, attachment, durationOpen, durationClose, arrow
