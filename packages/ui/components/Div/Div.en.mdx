...
## Tooltip
- renderTooltip (function: ReactNode | string | number): hidden part
- tooltipProps (object): additional parameters identical [Popover](/docs/popups/Popover): style, position, attachment, durationOpen, durationClose, arrow
