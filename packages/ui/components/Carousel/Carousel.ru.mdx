...
Возможность прокручивать мышкой/пальцем задается свойством isSwipe (по умолчанию - true)
...
Если нужна полная кастомизация стрелок или точек, можно передать ref, в нем будут содержаться функции для переключения: toLeft, toRight, toIndex
