...
- `onCrossPress` отображает крестик в заголовке который использует этот обработчик (он имеет более высокий приоритет чем `onClose`)
- `onClose` отображает кнопку отмены и крестик в заголовке которые используют этот обработчик
