...
- `onCrossPress` displays cross in title that uses this handler (it has a higher priority than `onClose`)
- `onClose` displays cancel button and cross in title that uses this handler
