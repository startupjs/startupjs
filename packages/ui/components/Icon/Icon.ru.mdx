...
Для использования Material icons fonts необходимо передать объект с типом иконки и code point

```jsx example
return (
  <Row align='around'>
    <Icon icon={{ type: 'material-icons', codePoint: 'e8b8' }} />
    <Icon icon={{ type: 'material-icons-round', codePoint: 'e8b6' }} />
    <Icon icon={{{ type: 'material-icons-two-tone', codePoint: 'e87d' }} />
  </Row>
)
```
