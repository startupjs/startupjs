...
```jsx example
return (
  <Link to='/docs/foundation/Typography/components'>
    Типография
  </Link>
)
```
...
return (
  <Link
    to='/docs/foundation/Typography/components'
    color='primary'
  >
    Типография
  </Link>
...
```jsx example
return (
  <Link to='/docs/foundation/Typography/components' bold>
    Типография
  </Link>
)
```
...
```jsx example
return (
  <Link to='/docs/foundation/Typography/components' italic>
    Типография
  </Link>
)
```
