...
The base component of typography is `Span`
...
To change text size use `font(size)` global mixin. Possible values of `size` (`h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `body1`, `body2`). `body2` is default `Span` size.
...
`H*` components are used for heading or subheadings of a section or ф page, and they also paste semantic tags to DOM on the web.
