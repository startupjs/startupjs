...
```jsx example
return (
  <Row style={{ flexGrow: 1, width: '100%', flexWrap: 'wrap' }}>
    <Tag style={{ marginTop: 8, marginRight: 8 }}>Primary (default)</Tag>
    <Tag style={{ marginTop: 8, marginRight: 8 }} color='success'>Success</Tag>
    <Tag style={{ marginTop: 8, marginRight: 8 }} color='warning'>Warning</Tag>
    <Tag style={{ marginTop: 8, marginRight: 8 }} color='error'>Error</Tag>
  </Row>
)
```
...
return (
  <Row style={{ flexGrow: 1, width: '100%', flexWrap: 'wrap' }}>
    <Tag
      style={{ marginTop: 8, marginRight: 8 }}
    >Круглая форма (по умолчанию)</Tag>
    <Tag
    style={{ marginTop: 8, marginRight: 8 }}
      shape='rounded'
    >Закругленная форма</Tag>
  </Row>
)
```
