...
Умный сайдбар обычно используется для навигации. Он предоставляет удобный десктоп-мобильный интерфейс. Основываясь на фиксированной точке останова макета, он решает остаться в качестве [видимой боковой панели](/docs/components/Sidebar) или превратиться в [невидимую боковую панель](/docs/components/DrawerSidebar). По умолчанию он не виден на экране.
