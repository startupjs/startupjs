...
## Без горизонтальных отступов

Чтобы удалить левый и правый отступы, передайте свойство `pure`. Это оставит максимальную ширину, но при этом вам надо будет променеджить паддинги самостоятельно.

Это полезно при создании списков, таблиц или других компонентов, которые на маленьких экранах должны выглядеть так, как будто они идут от левого к правому краю. В то время как на больших экранах вы все равно хотите ограничить максимальную ширину контента.
