...
- добавлено свойство `scrollEnabled` для установки горизонтального скролла полоски табов. Если вы установите `scrollEnabled` в значение `true`, вы также должны указать `width` в `tabStyle`.
