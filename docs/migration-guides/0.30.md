...
- **DateTimePicker**: 
  ...
  Need to manually install a new library `yarn add @react-native-community/datetimepicker` with your package manager, install pod for IOS and init backend side of UI on the server [See more](https://github.com/startupjs/startupjs/tree/master/packages/ui#configuration).
