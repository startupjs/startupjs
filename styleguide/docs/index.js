...
import AuthAppleRu from '../../packages/auth-apple/docs/readme.ru.mdx'
import AuthAppleEn from '../../packages/auth-apple/docs/readme.en.mdx'
import AuthAzureadRu from '../../packages/auth-azuread/docs/readme.ru.mdx'
import AuthAzureadEn from '../../packages/auth-azuread/docs/readme.en.mdx'
import AuthCommonRu from '../../packages/auth-common/docs/readme.ru.mdx'
import AuthCommonEn from '../../packages/auth-common/docs/readme.en.mdx'
import AuthFacebookRu from '../../packages/auth-facebook/docs/readme.ru.mdx'
import AuthFacebookEn from '../../packages/auth-facebook/docs/readme.en.mdx'
import AuthGoogleRu from '../../packages/auth-google/docs/readme.ru.mdx'
import AuthGoogleEn from '../../packages/auth-google/docs/readme.en.mdx'
import AuthLinkedinRu from '../../packages/auth-linkedin/docs/readme.ru.mdx'
import AuthLinkedinEn from '../../packages/auth-linkedin/docs/readme.en.mdx'
import AuthLocalRu from '../../packages/auth-local/docs/readme.ru.mdx'
import AuthLocalEn from '../../packages/auth-local/docs/readme.en.mdx'
